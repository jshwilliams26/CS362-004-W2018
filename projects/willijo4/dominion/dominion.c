...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	switch( card ) 
	{
		...
		case minion:
			return minion_func(state, handPos, currentPlayer, choice1, choice2);
		...
		case sea_hag:
			return sea_hag_func(state, currentPlayer);

		case treasure_map:
			return treasure_map_func(state, currentPlayer, handPos);
	}
